...
- Original: `cli.py` thin (argparse wiring + re-exports); logic in `cli_common`, `cli_lehrstoff`, `cli_students`, `cli_absences`, `cli_misc` with backward-compat re-exports (`from webuntis_agent.cli import …`).
